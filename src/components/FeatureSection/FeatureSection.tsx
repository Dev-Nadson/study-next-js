                ...
                <div className="grid space-y-10 grid-cols-1 md:grid-cols-2 md:gap-4 rounded-lg md:space-y-1 bg-zinc-900 p-6 md:p-12 hover:scale-103 transition-all">
                    <div className="flex flex-col gap-4 md:gap-0">
                        <div className="flex flex-col space-y-4">
                            ...
                            <h2 className="text-2xl text-gray-100 font-bold max-w-md">Tenha uma loja online personalizada com a cara da sua marca</h2>
                        </div>

                        <Button className="items-center rounded-full mt-4 hidden md:mt-auto md:p-0 md:flex max-w-60 h-12 text-white text-lg bg-blue-500 hover:bg-blue-600" asChild >
                    ...
                    <div className="flex flex-col items-center justify-center w-full ">
                        <div className="w-full max-w-md overflow-hidden">
                            <Image src="./image.svg" alt="" width={440} height={330} className="object-cover w-full scale-110" />
                        </div>
                    </div>
